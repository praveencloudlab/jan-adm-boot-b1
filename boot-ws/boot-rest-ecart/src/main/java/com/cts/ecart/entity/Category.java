...
public class Category {
	...
	@JoinTable(name = "category_info", joinColumns = @JoinColumn(name = "categoryId"), inverseJoinColumns = @JoinColumn(name = "productId"))
	private List<Product> mapProducts = new ArrayList<>();
	...
	public List<Product> getMapProducts() {
		return mapProducts;
	}

	public void setMapProducts(List<Product> mapProducts) {
