...
-- ----------------------------
BEGIN;
INSERT INTO `price_info_seq` (`next_val`) VALUES (351);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `products_seq` (`next_val`) VALUES (351);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `stock_info_seq` (`next_val`) VALUES (351);
COMMIT;
